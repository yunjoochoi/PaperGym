...
def fetch_paper_to_disk(*, arxiv_id: str, root: Path,
    ...
    If `cache_root` is given and <cache_root>/<arxiv_id>/paper.md exists
    (e.g., pre-converted on a GPU server), symlink it into <root>/<arxiv_id>/
    instead of re-downloading + re-converting.
    """
